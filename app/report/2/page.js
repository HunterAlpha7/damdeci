            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="text-center">
                            <div className="text-2xl font-bold text-red-600">{report.estimatedRepairCost}</div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="relative">
                            <div className="border-2 border-gray-200 rounded-lg overflow-hidden mb-2 h-48 flex items-center justify-center bg-gray-50">
                                <img
                                    src="/report_images/2/front_damage.jpg"
                                    alt="Front View"
                        ...
                        <div className="relative">
                            <div className="border-2 border-gray-200 rounded-lg overflow-hidden mb-2 h-48 flex items-center justify-center bg-gray-50">
                                <img
                                    src="/report_images/2/rear_damage.jpg"
                                    alt="Rear View"
                                    className="w-full h-full object-contain"
                                />
                            </div>
                        ...
                        <div className="relative">
                            <div className="border-2 border-gray-200 rounded-lg overflow-hidden mb-2 h-48 flex items-center justify-center bg-gray-50">
                                <img
                                    src="/report_images/2/left_damage.jpg"
                                    alt="Left View"
                                    className="w-full h-full object-contain"
                                />
                            </div>
                        ...
                        <div className="relative">
                            <div className="border-2 border-gray-200 rounded-lg overflow-hidden mb-2 h-48 flex items-center justify-center bg-gray-50">
                                <img
                                    src="/report_images/2/right_damage.jpg"
                                    alt="Right View"
                                    className="w-full h-full object-contain"
                                />
                            </div>
